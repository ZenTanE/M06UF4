...
public class Main {
    static DatabaseRepository repository = new MySQLRepository();
    //static DatabaseRepository repository = new MongoRepository();
    ...
    private static void testing() {
        ...
        //mongoRepository.createPerson(new Person(1, "anna"));
        //mongoRepository.readPerson(0);
        mongoRepository.readAllPersons();
        mongoRepository.createThing(new Thing("piso", 0));
        mongoRepository.readAllThingsByPersonid(0);
